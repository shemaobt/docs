...
**Reference basis:** [Speech to speech](/rfcs/speech-to-speech), [Training pipeline](/rfcs/training-pipeline)

### 1.2 Meaning map generation block

This block provides the semantic control structure for generation.

- **Input**: source passage analysis (pericope).
...
**Reference basis:** [Speech to speech](/rfcs/speech-to-speech), [Semantic acoustic mapping](/rfcs/semantic-acoustic-mapping)
...
**Reference basis:** [Semantic acoustic linking](/rfcs/semantic-acoustic-linking), [Oral-first acousteme translation reframe](/rfcs/oral-first-acousteme-translation-reframe)
...
```mermaid
flowchart LR
    A[Language Archive raw audio] --> B[SSL model<br/>HuBERT / wav2vec2 / XLS-R / MMS / XEUS]
...
- **Models**: self-supervised speech models such as HuBERT, wav2vec 2.0, XLS-R, MMS and XEUS.
...
**Reference basis:** [Parallel acousteme latent translation](/rfcs/parallel-acousteme-latent-translation), [Oral-first acousteme translation reframe](/rfcs/oral-first-acousteme-translation-reframe), [AudioLM integration](/rfcs/audiolm-integration)
...
**Reference basis:** [AudioLM integration](/rfcs/audiolm-integration), [Parallel acousteme latent translation](/rfcs/parallel-acousteme-latent-translation), [Oral-first acousteme translation reframe](/rfcs/oral-first-acousteme-translation-reframe), [Semantic acoustic linking](/rfcs/semantic-acoustic-linking)
